  ...
  return (
    <div style={{ width: window.innerWidth / 1.5 }}>
      <Accordion>
        ...
        <AccordionDetails>
            <Typography  variant="h5">{`typeDef:`}</Typography>
      ...
      <Accordion>
        <AccordionSummary
          ...
          id="panel2a-header"
        >
          <Typography>useHmack</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse
